...
static struct acpu_level tbl_slow_factory[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   975000 },
	{ 0, {   432000, HFPLL, 2, 0x20 }, L2(6),  1000000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(6),  1000000 },
	{ 0, {   540000, HFPLL, 2, 0x28 }, L2(6),  1000000 },
...
static struct acpu_level tbl_nom_factory[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   925000 },
	{ 0, {   432000, HFPLL, 2, 0x20 }, L2(6),   950000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(6),   950000 },
	{ 0, {   540000, HFPLL, 2, 0x28 }, L2(6),   975000 },
...
static struct acpu_level tbl_fast_factory[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   875000 },
	{ 0, {   432000, HFPLL, 2, 0x20 }, L2(6),   900000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(6),   900000 },
	{ 0, {   540000, HFPLL, 2, 0x28 }, L2(6),   925000 },
...
static struct acpu_level tbl_PVS0_1700MHz_factory[] __initdata = {
...
static struct acpu_level tbl_PVS1_1700MHz_factory[] __initdata = {
	{ 1, {	 384000, PLL_8, 0, 0x00 }, L2(0),   950000 },
	{ 1, {	 486000, HFPLL, 2, 0x24 }, L2(6),   950000 },
	{ 1, {	 594000, HFPLL, 1, 0x16 }, L2(6),   950000 },
	{ 1, {	 702000, HFPLL, 1, 0x1A }, L2(6),   962500 },
...
static struct acpu_level tbl_PVS2_1700MHz_factory[] __initdata = {
	{ 1, {	 384000, PLL_8, 0, 0x00 }, L2(0),   925000 },
...
static struct acpu_level tbl_PVS3_1700MHz_factory[] __initdata = {
...
static struct acpu_level tbl_PVS4_1700MHz_factory[] __initdata = {
	{ 1, {	 384000, PLL_8, 0, 0x00 }, L2(0),   875000 },
...
static struct acpu_level tbl_PVS5_1700MHz_factory[] __initdata = {
	{ 1, {	 384000, PLL_8, 0, 0x00 }, L2(0),   875000 },
	{ 1, {	 486000, HFPLL, 2, 0x24 }, L2(6),   875000 },
	{ 1, {	 594000, HFPLL, 1, 0x16 }, L2(6),   875000 },
	{ 1, {	 702000, HFPLL, 1, 0x1A }, L2(6),   875000 },
...
static struct acpu_level tbl_PVS6_1700MHz_factory[] __initdata = {
	{ 1, {	 384000, PLL_8, 0, 0x00 }, L2(0),   875000 },
	{ 1, {	 486000, HFPLL, 2, 0x24 }, L2(6),   875000 },
	{ 1, {	 594000, HFPLL, 1, 0x16 }, L2(6),   875000 },
	{ 1, {	 702000, HFPLL, 1, 0x1A }, L2(6),   875000 },
...
static struct pvs_table pvs_tables_factory_56k[NUM_SPEED_BINS][NUM_PVS] __initdata = {
	...
	[1][0] = { tbl_PVS0_1700MHz_factory, sizeof(tbl_PVS0_1700MHz_factory),     0 },
	[1][1] = { tbl_PVS1_1700MHz_factory, sizeof(tbl_PVS1_1700MHz_factory),     25000 },
	[1][2] = { tbl_PVS2_1700MHz_factory, sizeof(tbl_PVS2_1700MHz_factory),     25000 },
	[1][3] = { tbl_PVS3_1700MHz_factory, sizeof(tbl_PVS3_1700MHz_factory),     25000 },
	[1][4] = { tbl_PVS4_1700MHz_factory, sizeof(tbl_PVS4_1700MHz_factory),     25000 },
	[1][5] = { tbl_PVS5_1700MHz_factory, sizeof(tbl_PVS5_1700MHz_factory),     25000 },
	[1][6] = { tbl_PVS6_1700MHz_factory, sizeof(tbl_PVS6_1700MHz_factory),     25000 },
...
static struct pvs_table pvs_tables_factory[NUM_SPEED_BINS][NUM_PVS] __initdata = {
	[0][PVS_SLOW]    = {tbl_slow_factory, sizeof(tbl_slow_factory),     0 },
	[0][PVS_NOMINAL] = {tbl_nom_factory,  sizeof(tbl_nom_factory),  25000 },
	[0][PVS_FAST]    = {tbl_fast_factory, sizeof(tbl_fast_factory), 25000 },
	[0][PVS_FASTER]  = {tbl_fast_factory, sizeof(tbl_fast_factory), 25000 },
